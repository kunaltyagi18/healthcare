...
export const Youtube = ({ size = 24, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M2.5 7.1C2.5 7.1 2 9 2 12c0 3 .5 4.9.5 4.9C3 18.3 4.3 19.6 5.8 19.8 8.1 20 12 20 12 20s3.9 0 6.2-.2c1.5-.2 2.8-1.5 3.3-2.9.5 0 .5-1.9.5-4.9 0-3-.5-4.9-.5-4.9C21 5.7 19.7 4.4 18.2 4.2 15.9 4 12 4 12 4s-3.9 0-6.2.2C4.3 4.4 3 5.7 2.5 7.1z"/><path d="m10 15 5-3-5-3v6z"/></svg>
);
